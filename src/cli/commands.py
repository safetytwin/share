...
from ..p2p.protocol import (
    Message, VMCreateMessage, VMStartMessage, VMStopMessage, 
    VMDeleteMessage, VMListMessage, VMInfoMessage, VMStatusMessage
)
...
class CLI:
    ...
    def _create_parser(self) -> argparse.ArgumentParser:
        ...
        vm_parser = subparsers.add_parser(
            "vm",
            help="Zarządzanie maszynami wirtualnymi"
        )
        
        vm_subparsers = vm_parser.add_subparsers(
            dest="vm_command",
            title="Komendy VM",
            help="Komenda VM do wykonania"
        )
        
        # Komenda: vm list
        vm_list_parser = vm_subparsers.add_parser(
            "list",
            help="Listuje dostępne maszyny wirtualne"
        )
        ...
        vm_create_parser = vm_subparsers.add_parser(
            "create",
            help="Tworzy nową maszynę wirtualną"
        )
        
        vm_create_parser.add_argument(
            "name",
            type=str,
            help="Nazwa maszyny wirtualnej"
        )
        ...
        vm_create_parser.add_argument(
            ...
            type=int,
            default=2,
            help="Liczba rdzeni CPU (domyślnie: 2)"
        )
        ...
        vm_create_parser.add_argument(
            ...
            type=int,
            default=20,
            help="Rozmiar dysku w GB (domyślnie: 20)"
        )
        ...
        vm_start_parser = vm_subparsers.add_parser(
            "start",
            help="Uruchamia maszynę wirtualną"
        )
        ...
        vm_stop_parser = vm_subparsers.add_parser(
            "stop",
            help="Zatrzymuje maszynę wirtualną"
        )
        ...
        vm_delete_parser.add_argument(
            "--keep-disk",
            action="store_true",
            help="Zachowuje dysk maszyny wirtualnej"
        )
        
        # Komenda: vm status
        vm_status_parser = vm_subparsers.add_parser(
            "status",
            help="Pobiera status maszyny wirtualnej"
        )
        
        vm_status_parser.add_argument(
            "name",
            type=str,
            help="Nazwa maszyny wirtualnej"
        )
        ...
        p2p_send_parser = p2p_subparsers.add_parser(
            "send",
            help="Wysyła wiadomość do węzła P2P"
        )
        
        p2p_send_parser.add_argument(
            "peer_id",
            type=str,
            help="Identyfikator węzła docelowego"
        )
        ...
        p2p_send_parser.add_argument(
            "data",
            type=str,
            help="Dane wiadomości w formacie JSON"
        )
        
        # Komenda: remote
        remote_parser = subparsers.add_parser(
            "remote",
            help="Zdalne zarządzanie maszynami wirtualnymi"
        )
        ...
        remote_vm_list_parser = remote_subparsers.add_parser(
            "vm-list",
            help="Listuje zdalne maszyny wirtualne"
        )
        ...
        remote_vm_create_parser = remote_subparsers.add_parser(
            "vm-create",
            help="Tworzy zdalną maszynę wirtualną"
        )
        ...
        remote_vm_start_parser = remote_subparsers.add_parser(
            "vm-start",
            help="Uruchamia zdalną maszynę wirtualną"
        )
        ...
        remote_vm_start_parser.add_argument(
            "vm_id",
            type=str,
            help="Identyfikator maszyny wirtualnej"
        )
        
        # Komenda: remote vm-stop
        remote_vm_stop_parser = remote_subparsers.add_parser(
            "vm-stop",
            help="Zatrzymuje zdalną maszynę wirtualną"
        )
        ...
        remote_vm_delete_parser = remote_subparsers.add_parser(
            "vm-delete",
            help="Usuwa zdalną maszynę wirtualną"
        )
